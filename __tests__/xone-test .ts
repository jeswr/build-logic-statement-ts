...
import { XoneBuilder } from "../lib";

describe('Xone Builder Tests', () => {
  it('should build an empty xone statement', () => {
    expect(new XoneBuilder().build()).toEqual({
  ...
  it('should handle having statements added to each entry', () => {
    const builder = new XoneBuilder<string>();
    builder.addAnd()
    builder.addOr()
