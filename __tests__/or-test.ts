...
import { OrBuilder } from "../lib";

describe('Or Builder Tests', () => {
  it('should build an empty or statement', () => {
    expect(new OrBuilder().build()).toEqual({
  ...
  it('should handle having statements added to each entry', () => {
    const builder = new OrBuilder<string>();
    builder.addAnd()
    builder.addOr()
